...
class thirtytwo_head_model(nn.Module):
...
if __name__=="__main__":
    config=RoPE_config()
    model=thirtytwo_head_model(config)
    model.to(device)
    ...
    torch.save(model.state_dict(),"thirtytwo_head_model.pt")
    print("Saved thirtytwo_head_model.pt")