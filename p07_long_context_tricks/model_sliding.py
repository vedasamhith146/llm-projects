...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        window_mask=torch.triu(torch.ones(T,T),diagonal=-self.window)
        banded_mask=(casual_mask*window_mask).view(1,1,T,T)
        att=att.masked_fill(banded_mask[:,:,:T,:T]==0,float('-inf'))
