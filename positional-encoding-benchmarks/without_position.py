...
class without_position_model(nn.Module):
...
if __name__=="__main__":
    config=without_position_config()
    model=without_position_model(config)
    model.to(device)
    ...
    torch.save(model.state_dict(),"without_position__model.pt")
    print("Saved without_position_model.pt")